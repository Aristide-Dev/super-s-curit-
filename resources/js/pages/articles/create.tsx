...
import ArticleForm, { type StatusOption } from '@/components/articles/article-form';
...
export default function ArticlesCreate() {
    const { statusOptions, defaultStatus, errors } =
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">
                        Rédigez un article et choisissez son statut de
                        publication.
                    </p>
                </div>
